...
from posts.views import feeds, comment_add, comment_delete, post_add, tags, post_detail, post_like, post_delete, \
    post_edit, post_image_delete, post_tag_delete, post_search, post_search_do, post_download_images, message_add
...
urlpatterns = [
    ...
    # 추가
    path('message_add/', message_add, name="message_add"),
    # 추가
    ...
    # 추가
    path('post_download_images/<int:post_id>/', post_download_images, name='post_download_images'),
    # 추가
